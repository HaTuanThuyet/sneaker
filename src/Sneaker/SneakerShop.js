...
export default class SneakerShop extends Component {
    product = [
        {
          "id": 1,
    ...
    render() {
        return (
            <div className="container">
              <ProductList arraySneaker={this.product} xemChitiet={this.xemChitiet}/>
              <Modal productDetail={this.state.detail}/>
